...
//	user1.setPassword("123456"); user1.setRole(rolesService.getRoles()[0]);
//	User user2 = new User("99999991B", "Lucas", "Núñez");
//	user2.setPassword("123456"); user2.setRole(rolesService.getRoles()[0]);
//	User user3 = new User("99999992C", "María", "Rodríguez");
//	user3.setPassword("123456"); user3.setRole(rolesService.getRoles()[0]);
//	User user4 = new User("99999993D", "Marta", "Almonte");
//	user4.setPassword("123456"); user4.setRole(rolesService.getRoles()[1]);
//	User user5 = new User("99999977E", "Pelayo", "Valdes");
//	user5.setPassword("123456"); user5.setRole(rolesService.getRoles()[1]);
//	User user6 = new User("99999988F", "Edward", "Núñez");
//	user6.setPassword("123456"); user6.setRole(rolesService.getRoles()[2]);
