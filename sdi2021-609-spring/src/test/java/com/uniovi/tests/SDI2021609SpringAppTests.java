...
public class SDI2021609SpringAppTests {
...
//	static String Geckdriver024 = "/Users/delacal/selenium/geckodriver024mac"; 
	...
	public void PR05() {
		...
		PO_View.checkElement(driver, "text", "Notas de usuario");
	}
	...
	public void PR06() {
		...
		// Comprobamos el error de Apellidos corto.
		PO_RegisterView.checkKey(driver, "Error.signup.lastName.length", PO_Properties.getSPANISH());
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Pérez", "77777", "77778");
		// Comprobamos el error de las contrasenas no coinciden.
		PO_RegisterView.checkKey(driver, "Error.signup.passwordConfirm.coincidence", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Pérez", "7777", "7777");
		// Comprobamos el error de las contrasenas cortas.
		PO_RegisterView.checkKey(driver, "Error.signup.password.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999999999999999999999999990A", "Josefo", "Perez", "77777", "77777");
		PO_View.getP();
		// COmprobamos el error de DNI largo.
		PO_RegisterView.checkKey(driver, "Error.signup.dni.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Joseeeeeeeeeeeeeeeeeeeeeeeeeeee", "Perez", "77777", "77777");
		// COmprobamos el error de Nombre largo.
		PO_RegisterView.checkKey(driver, "Error.signup.name.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Per", "77777777777777777777777777777",
				"77777777777777777777777777777");
		// Comprobamos el error de contraseña largo.
		PO_RegisterView.checkKey(driver, "Error.signup.password.length", PO_Properties.getSPANISH());
	}
	...
	// Este usuario hace login adecuadamente, el error del test occure porque no
	// encuentra
	// el "text" en la página, no sé porque.
	@Test
	public void PR10() {
		// Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	...
	public void PR11() {
		...
		// COmprobamos que entramos en la pagina privada de Administrador
		PO_View.checkElement(driver, "text", "Notas del usuario");
		// desconectar la sesión con el usuario que ha hecho login
		PO_HomeView.clickOption(driver, "logout", "class", "btn btn-primary");
		// nos redirige a la página inicial para hacer login
	...
	public void PR13() {
		...
		// viewDetailsMarkFirstPage // driver, description
	...
	// PR14. Esta prueba podría encapsularse mejor ...
	@Test
	public void PR14() {
		PO_PrivateView.login(driver, "99999993D", "123456");

		List<WebElement> elementos = PO_PrivateView.clickMenuOption(driver, "marks-menu", "mark/add");
